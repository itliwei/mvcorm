...
import io.github.itliwei.mvcorm.generator.generator.meta.mysql.MysqlTableMeta;
import io.github.itliwei.mvcorm.generator.generator.meta.mysql.MysqlTableMeta.MysqlColumnMeta;
...
import static io.github.itliwei.mvcorm.generator.generator.util.ClassHelper.getFields;
...
public class MysqlHandler extends ScopedHandler<MysqlTableMeta> {
    ...
    protected MysqlTableMeta parse(Class<?> entityClass) throws Exception {
        ...
        io.github.itliwei.mvcorm.generator.annotation.Type type = entityClass.getDeclaredAnnotation(io.github.itliwei.mvcorm.generator.annotation.Type.class);
        if (type != null) {
            mtm.setComment(type.label());
        }
        if (StringUtils.isBlank(mtm.getComment())) {
            mtm.setComment(table.comment());
        }
