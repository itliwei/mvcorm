...
import static io.github.itliwei.mvcorm.entity.UserCodeLog.SIMPLE_DTO;
import static io.github.itliwei.mvcorm.entity.UserCodeLog.SIMPLE_VO;


/**
 * @author : liwei
 * @date : 2019/06/24 09:49
 * @description : 用户获取动态码日志
 */
...
@Type(label = "用户")
@QueryModel
@Table(value = "t_user_code_log")
@ServiceClass
@ControllerClass
@ViewObject(groups = {SIMPLE_VO,SIMPLE_DTO})
public class UserCodeLog extends IdEntity {
    public static final String SIMPLE_VO = "UserCodeVo";
    public static final String SIMPLE_DTO = "UserCodeDto";
