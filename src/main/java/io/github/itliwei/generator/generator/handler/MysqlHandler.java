...
import io.github.itliwei.generator.generator.meta.mysql.MysqlTableMeta;
import io.github.itliwei.generator.generator.meta.mysql.MysqlTableMeta.MysqlColumnMeta;
...
public class MysqlHandler extends ScopedHandler<MysqlTableMeta> {
    ...
    protected MysqlTableMeta parse(Class<?> entityClass) throws Exception {
        ...
        io.github.itliwei.generator.annotation.Type type = entityClass.getDeclaredAnnotation(io.github.itliwei.generator.annotation.Type.class);
        if (type != null) {
